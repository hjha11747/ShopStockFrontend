    ...
    <section className='max_padd_container py-20'>
      <div>
        ...
        <div className='flexBetween my-8 mx-2'>
          <h5><span className='font-bold'>  {showMore ? 'Showing 1-36' : 'Showing 1-12'} </span>out of 36 products </h5>
          <div className='flexBetween max-sm:px-4 gap-x-4 px-8 py-3 rounded-xl ring-1 ring-slate-900/15'>Sort by <MdOutlineKeyboardArrowDown /></div>
        </div>
