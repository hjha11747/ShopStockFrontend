...
const Offer = () => {
    ...
    return (
        <section className='bg-slate-300 bg-cover w-[90%] flex justify-between items-center mx-auto rounded-lg'>
            <div className='px-24 py-24 max-lg:px-14 max-md:px-10 max-sm:px-4'>
            ...
            <div>
                <img
                    ...
                    className='w-[400px] h-[450px] max-lg:h-[380px] max-md:h-[350px] max-lg:w-[330px] max-md:w-[300px] rounded-lg'
                    alt=""
                />
            </div>
        </section>
